...
public class OpenCL {
    ...
    private static IntBuffer lastErrorCode = BufferUtils.createIntBuffer(1);
    public static boolean checkError = true;
    
    public static int CL_MEM_WRITE_ONLY = CL10.CL_MEM_WRITE_ONLY;
    public static int CL_MEM_READ_ONLY = CL10.CL_MEM_READ_ONLY;
    public static int CL_MEM_READ_WRITE = CL10.CL_MEM_READ_WRITE;
    public static int CL_SUCCESS = CL10.CL_SUCCESS;
    ...
    /**
     * Erstellt einen neuen leeren OpenCL Buffer.
     ...
     * @param flags CL_MEM_WRITE_ONLY, CL_MEM_READ_ONLY, CL_MEM_READ_WRITE
     * @param host_ptr Groesse in BYTE
     * @return CLMem
     */
    ...
    /**
     * Erstellt einen neuen OpenCL Buffer auf Basis eines FloatBuffer.
     * @see <a href="http://www.khronos.org/registry/cl/sdk/1.0/docs/man/xhtml/clCreateBuffer.html">clCreateBuffer</a>
     * @param context CLContext Objekt
     * @param flags CL_MEM_WRITE_ONLY, CL_MEM_READ_ONLY, CL_MEM_READ_WRITE
     * @param host_ptr FloatBuffer
     * @return CLMem
     */
    ...
    /**
     * Erstellt einen neuen OpenCL Buffer auf Basis eines ByteBuffer.
     * @see <a href="http://www.khronos.org/registry/cl/sdk/1.0/docs/man/xhtml/clCreateBuffer.html">clCreateBuffer</a>
     * @param context CLContext Objekt
     * @param flags CL_MEM_WRITE_ONLY, CL_MEM_READ_ONLY, CL_MEM_READ_WRITE
     * @param host_ptr ByteBuffer
     * @return CLMem
     */
    ...
    /**
     * Erstellt einen neuen OpenCL Buffer auf Basis eines IntBuffer.
     * @see <a href="http://www.khronos.org/registry/cl/sdk/1.0/docs/man/xhtml/clCreateBuffer.html">clCreateBuffer</a>
     * @param context CLContext Objekt
     * @param flags CL_MEM_WRITE_ONLY, CL_MEM_READ_ONLY, CL_MEM_READ_WRITE
     * @param host_ptr IntBuffer
     * @return CLMem Objekt
     */
    ...
    /**
     * Erzeugt ein CLKernel Objekt
     * @see <a href="http://www.khronos.org/registry/cl/sdk/1.0/docs/man/xhtml/clCreateKernel.html">clCreateKernel</a>
     * @param program CLProgram Objekt welches den Kernel enthaelt
     * @param name Name des Kernels
     * @return CLKernel Objekt
     */
    ...
    /**
     * Erzeugt ein CLProgram Objekt aus dem uebergebenen Quelltext
