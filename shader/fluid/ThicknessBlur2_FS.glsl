...
color =  (/* texture( thickness, texCoords-vec2(0, 12/800) )
		 ...
		 + texture( thickness, texCoords-vec2(0, 5/800) ) */
		  texture( thickness, texCoords-vec2(0, 4.0/800.0) ) * 0.05
		 + texture( thickness, texCoords-vec2(0, 3.0/800.0) ) * 0.09
		 + texture( thickness, texCoords-vec2(0, 2.0/800.0) ) * 0.12
		 + texture( thickness, texCoords-vec2(0, 1.0/800.0) ) * 0.15
