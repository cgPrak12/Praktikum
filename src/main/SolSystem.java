...
public class SolSystem {
    ...
    public static void main(String[] argv) {
        try {
            ...
            asteroids = new Asteroids(Device_Type.GPU, Display.getDrawable());
    ...
    public static void render() throws LWJGLException {
        ...
        while(bContinue && !Display.isCloseRequested()) {
            ...
            glUseProgram(asteroids.getShaderProgram());
            for(int i=0; i < MAX_ORBS; ++i) {
                orbs[i].bindLightInformationToShader(asteroids.getShaderProgram(), i);
            }
            //asteroids
            asteroids.draw(cam);
    ...
    private static void animate(long millis) {
        ...
        asteroids.updateSimulation(millis);
    }
