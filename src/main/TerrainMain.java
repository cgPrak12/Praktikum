...
public class TerrainMain
{
	...
	public static void main(String[] argv)
	{
		try
		{
			...
			/* Folgende drei Zeilen nur beim ersten Mal ausfuehren, nach beschreiben der Festplatte auskommentieren */
			TerrainFactory.init();
			...
			tex.bind();
			glTexImage2D(GL_TEXTURE_2D, 0, GL30.GL_R32F, terra.getSize(), terra.getSize(), 0, GL11.GL_RED, GL_FLOAT, fbuffer);
